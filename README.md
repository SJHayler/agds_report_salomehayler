...
You can already have a look at my rendered Markdown scripts without reproducing the workflow by yourself (see files phenology_modelling.html and soil_mapping.html)
